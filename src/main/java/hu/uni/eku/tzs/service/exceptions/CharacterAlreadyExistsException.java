...
public class CharacterAlreadyExistsException extends Exception {
    ...
    public CharacterAlreadyExistsException(String message, Throwable cause) { super(message, cause); }

    public CharacterAlreadyExistsException(Throwable cause) { super(cause); }
